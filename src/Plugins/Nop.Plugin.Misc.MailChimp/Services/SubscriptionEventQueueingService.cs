...
namespace Nop.Plugin.Misc.MailChimp.Services
{
    ...
    {
        private const string QUEUE_ALL_RECORDS = "INSERT INTO MailChimpEventQueueRecord (Email, IsSubscribe, CreatedOnUtc, AdditionalInfo, SuscriptionTypeId) SELECT Email, 1, getutcdate(), AdditionalInfo, SuscriptionTypeId FROM NewsLetterSubscription WHERE Active = 1";
