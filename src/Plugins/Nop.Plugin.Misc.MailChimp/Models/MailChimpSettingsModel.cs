...
namespace Nop.Plugin.Misc.MailChimp.Models
{
    public class MailChimpSettingsModel
    {
        ...
        [NopResourceDisplayName("Plugin.Misc.MailChimp.UserSuscriptionListId")]
        public virtual string UserSuscriptionListId { get; set; }


        [NopResourceDisplayName("Plugin.Misc.MailChimp.GeneralSuscriptionListId")]
        public virtual string GeneralSuscriptionListId { get; set; }

        [NopResourceDisplayName("Plugin.Misc.MailChimp.ShopSuscriptionListId")]
        public virtual string ShopSuscriptionListId { get; set; }

        [NopResourceDisplayName("Plugin.Misc.MailChimp.RepairShopSuscriptionListId")]
