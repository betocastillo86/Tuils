...
namespace Nop.Web.Extensions.Api
{
    public static class ApiValidationExtensions
    {
        ...
        public static bool Validate(this ProductBaseModel model, System.Web.Http.ModelBinding.ModelStateDictionary modelState, out ProductCategoryType productType)
        {
            ...
            {
                productType = ProductCategoryType.Product;
                //Si es tipo producto
                //debe tener marca
            ...
            {
                productType = ProductCategoryType.Motorcycle;
            ...
            {
                productType = ProductCategoryType.Service;
            ...
            {
                productType = ProductCategoryType.None;
                return false;
            }
