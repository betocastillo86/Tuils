    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Nop.Data.NopObjectContext>
    {
        ...
        protected override void Seed(Nop.Data.NopObjectContext context)
        {
            ...
            if (runResources)
            {
                ...
                newLocaleStringResources.Add("Filtering.StateProvinceFilter", "Filtrar por ciudad");
                ...
                newLocaleStringResources.Add("Filtering.CategoryFilter", "Filtrar por categoria");
                newLocaleStringResources.Add("Filtering.CategoryFilter.CurrentlyFilteredBy", "Ya filtró por");
                newLocaleStringResources.Add("Filtering.ManufacturerFilter", "Filtar por marca");
                ...
                newLocaleStringResources.Add("Filtering.BikeReferenceFilter", "Filtrar por moto");
            ...
            if (runSettings)
            {
                ...
                settings.Add("tuilssettings.specificationattributeaccesories", "1007");
                settings.Add("tuilssettings.specificationattributenegotiation", "1006");
                settings.Add("tuilssettings.specificationattributeoptionkms", "1031");
                settings.Add("tuilssettings.specificationattributeoptioncarriageplate", "1033");
                settings.Add("tuilssettings.defaultcountry", "1");
                settings.Add("tuilssettings.specificationattributesupplies", "1011");
