    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Nop.Data.NopObjectContext>
    {
        ...
        protected override void Seed(Nop.Data.NopObjectContext context)
        {
            ...
            if (runResources)
            {
                ...
                /***SOLO CORRER UNA VEZ***/
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.Market.26", "Darémos asistencia completa para la configuración de su tienda virtual en Tuils. Tomamos fotografías profesionales de la sede principal * y las configuramos en su tienda virtual.  <br><div style='font-size:8px'>La toma de fotografías solo aplica en Bogotá y no incluye toma de fotografías de productos</div>");
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.Market.25", "Número de productos que aparecerán en nuestras redes sociales de Facebook e Instagram. Si escogé un plan que permita publicar 2 productos en redes sociales, estos dos saldrán publicados en el transcurso del mes.* <div style='font-size:8px'>Solo se garantiza la publicación por redes sociales una vez por mes por producto</div>");
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.Market.24", "Número de productos que aparecerán en la pagina principal de Tuils. Si escogé un plan que permita publicar 2 productos en la página principal, estos dos saldrán publicados en el transcurso del mes.* <div style='font-size:8px'>Debido a la cantidad de productos publicados en la página princial es posible que no todas las veces que recargue su navegador el producto salga en la pagina principal. Tenga en cuenta que debido a la gran cantidad de visitas que tenemos en Tuils mucha gente verá su producto destacado</div>");
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.Market.23", "Número de productos que aparecerán en las paginas principales de categorías y marcas. Cuando seleccione un plan con esta característica los productos se verán en la parte superior de la categoría correspondiente al producto, así como a su correspondiente marca. Adicionalmente saldrá destacado como relacionado de productos que se encuentren en la misma categoría. * <div style='font-size:8px'>Debido a la cantidad de productos publicados como destacados es posible que no todas las veces que recargue su navegador el producto salga en la pagina principal. Tenga en cuenta que debido a la gran cantidad de visitas que tenemos en Tuils mucha gente verá su producto destacado.</div>");
                ...
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.Market.18", "Su empresa será publicada en nuestras redes sociales Facebook e Instagram en el transcurso del mes.* <div style='font-size:8px'>Solo se garantiza la publicación por redes sociales una vez por mes.</div>");
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.User.18", "Tu producto será pulicado en nuestras redes sociales en el transcurso de los 3 primeros días después de la publicación.* <div style='font-size:8px'>Solo se garantiza la publicación por redes sociales una vez por publicación.</div>");
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.Market.17", "Su empresa aparecerá en la pagina principal de Tuils durante el transcurso del plan.* <div style='font-size:8px'>Debido a la cantidad de productos publicados en la página princial es posible que no todas las veces que recargue su navegador el producto salga en la pagina principal. Tenga en cuenta que debido a la gran cantidad de visitas que tenemos en Tuils mucha gente verá su producto destacado</div>");
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.User.17", "Tu producto aparecerá en la pagina principal de Tuils.* <div style='font-size:8px'>Debido a la cantidad de productos publicados en la página princial es posible que no todas las veces que recargues el navegador veas tu producto en la pagina principal.  Pero ten en cuenta que debido a la gran cantidad de visitas que tenemos en Tuils mucha gente seguramente verá tu producto ;).</div>");
                newLocaleStringResources.Add("showplans.specificationAttributeDescription.User.16", "Tu producto aparecerá en la pagina principales de la categoría y la marca a la que pertenece tu producto. Adicionalmente saldrá como producto relacionado de los productos que esten en la misma categoría de tu producto.. * <div style='font-size:8px'>Debido a la cantidad de productos publicados como destacados es posible que no todas las veces que recargues tu navegador veas tu producto. Pero ten en cuenta que ya que tenemos muchas visitas en Tuils mucha gente seguramente verá tu producto ;).</div>");
