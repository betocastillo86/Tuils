...
namespace Nop.Services.Catalog
{
    ...
    public partial class SpecificationAttributeService : ISpecificationAttributeService
    {
        ...
        /// {2} : show on product page
        /// </remarks>
        private const string CATEGORYSPECIFICATIONATTRIBUTE_ALLBYPRODUCTID_KEY = "Nop.categoriespecificationattribute.allbycategoryid-{0}-{1}-{2}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CATEGORIESPECIFICATIONATTRIBUTE_PATTERN_KEY = "Nop.categoriespecificationattribute.";
        #endregion
        ...
        public virtual void DeleteCategorySpecificationAttribute(CategorySpecificationAttribute categorySpecificationAttribute)
        {
            ...
            _cacheManager.RemoveByPattern(CATEGORIESPECIFICATIONATTRIBUTE_PATTERN_KEY);
        ...
        /// <returns>Product specification attribute mapping collection</returns>
        public virtual IList<CategorySpecificationAttribute> GetCategorySpecificationAttributesByCategoryId(int categoryId)
        {
            return GetCategorySpecificationAttributesByCategoryId(categoryId, null, null);
        }
        ...
        /// <param name="categoryId">Product identifier</param>
        /// <param name="allowFiltering">0 to load attributes with AllowFiltering set to false, 0 to load attributes with AllowFiltering set to true, null to load all attributes</param>
        /// <param name="showOnCategoryPage">0 to load attributes with ShowOnProductPage set to false, 0 to load attributes with ShowOnProductPage set to true, null to load all attributes</param>
        /// <returns>Product specification attribute mapping collection</returns>
        public virtual IList<CategorySpecificationAttribute> GetCategorySpecificationAttributesByCategoryId(int categoryId,
            bool? allowFiltering, bool? showOnCategoryPage)
        {
            ...
            if (allowFiltering.HasValue)
                allowFilteringCacheStr = allowFiltering.ToString();
            string showOnCategoryPageCacheStr = "null";
            if (showOnCategoryPage.HasValue)
                showOnCategoryPageCacheStr = showOnCategoryPage.ToString();
            string key = string.Format(CATEGORYSPECIFICATIONATTRIBUTE_ALLBYPRODUCTID_KEY, categoryId, allowFilteringCacheStr, showOnCategoryPageCacheStr);
        ...
        /// Gets a product specification attribute mapping 
        /// </summary>
        /// <param name="categorySpecificationAttributeId">Product specification attribute mapping identifier</param>
        /// <returns>Product specification attribute mapping</returns>
        ...
        /// Inserts a product specification attribute mapping
        /// </summary>
        /// <param name="categorySpecificationAttribute">Product specification attribute mapping</param>
