...
namespace Nop.Web.MVC.Tests.Public.Infrastructure
{
    ...
    public class RoutesTests : RoutesTestsBase
    {
        ...
        public void Customer_routes()
        {
            ...
            //"~/salir/".ShouldMapTo<CustomerController>(c => c.Logout());
        ...
        {
            "~/contacto".ShouldMapTo<CommonController>(c => c.ContactUs());
            "~/mapa-del-sitio".ShouldMapTo<CommonController>(c => c.Sitemap());
